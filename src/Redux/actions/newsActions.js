...
export const deleteNews = (newsId, handleClose) => (dispatch) => {
  axios.get(`/delete/${newsId}`).then((res) => {
...
export const deleteAlumini = (aluminiID, handleClose) => (dispatch) => {
  axios.get(`delete/alumini/${aluminiID}`).then((res) => {
    console.log(res.data)
    dispatch({
      type: DELETE_ALUMINI,
      payload: aluminiID,
...
export const editAlumini = (aluminiID, data, handleClose) => (dispatch) => {
  dispatch({ type: LOADING_UI })
  axios
    .post(`/edit/alumini/${aluminiID}`, data)
    .then((res) => {
      // console.log(res);
      dispatch(getAlumini())
      handleClose()
...
export const editLeader = (leaderId, data, handleClose) => (dispatch) => {
  dispatch({ type: LOADING_UI })
  axios
    .post(`/edit/leaders/${leaderId}`, data)
    .then((res) => {
      // console.log(res);
      dispatch(getLeaders())
      handleClose()
...
export const editChairman = (leaderId, data, handleClose) => (dispatch) => {
  dispatch({ type: LOADING_UI })
  axios
    .post(`/edit/chairman/${leaderId}`, data)
    .then((res) => {
      // console.log(res);
...
export const deleteChairman = (chairmanID, handleClose) => (dispatch) => {
  axios.get(`delete/chairman/${chairmanID}`).then((res) => {
    console.log(res.data)
    dispatch({
...
export const editPastLeader = (leaderId, data, handleClose) => (dispatch) => {
  dispatch({ type: LOADING_UI })
  axios
    .post(`/edit/past-leader/${leaderId}`, data)
    .then((res) => {
      // console.log(res);
...
export const deletePastLeader = (LeaderID, handleClose) => (dispatch) => {
  axios.get(`delete/past-leader/${LeaderID}`).then((res) => {
    console.log(res.data)
    dispatch({
...
export const submitContactForm = (data, setDialogStatus) => (dispatch) => {
  dispatch({ type: LOADING_UI })
  axios
